...
def create_env(env_path, worker_id=6, time_scale=1.0):
...
if __name__ == '__main__':
    ...
    model = TD3("MlpPolicy", env_scene1, verbose=2, tensorboard_log=tensorboard_log_path_scene1, policy_kwargs=policy_kwargs)
    ...
    env_scene2 = create_env(scene2_env, worker_id=7, time_scale=1.0)
    ...
    model = TD3.load(final_model_path_scene1, env=env_scene2, tensorboard_log=tensorboard_log_path_scene2, policy_kwargs=policy_kwargs, verbose=2)
    ...
    env_scene3 = create_env(scene3_env, worker_id=9, time_scale=1.0)
    ...
    model = TD3.load(final_model_path_scene2, env=env_scene3, tensorboard_log=tensorboard_log_path_scene3, policy_kwargs=policy_kwargs, verbose=2)
