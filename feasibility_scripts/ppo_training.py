...
def create_env(env_path, worker_id=0, time_scale=1.0, no_graphics = True):
...
if __name__ == '__main__':
    ...
    model = PPO.load(final_model_path_scene1 + ".zip", env=env_scene2, tensorboard_log=tensorboard_log_path_scene2, policy_kwargs=policy_kwargs, verbose=2, learning_rate=1e-4)
    ...
    final_model_path_scene2 = get_save_path(trained_models_path, model_name, trained_path=True)
    ...
    model = PPO.load(final_model_path_scene2 + ".zip", env=env_scene3, tensorboard_log=tensorboard_log_path_scene3, policy_kwargs=policy_kwargs, verbose=2, learning_rate=5e-4)
    ...
    final_model_path_scene3 = get_save_path(trained_models_path, model_name, trained_path=True)
