...
if __name__ == '__main__':
    ...
    model = SAC("MlpPolicy", env_scene1, verbose=2, tensorboard_log=tensorboard_log_path_scene1, policy_kwargs=policy_kwargs, learning_rate=3e-4)
    ...
    model = SAC.load(final_model_path_scene1, env=env_scene2, tensorboard_log=tensorboard_log_path_scene2, policy_kwargs=policy_kwargs, verbose=2, learning_rate=1e-4)
    ...
    model = SAC.load(final_model_path_scene2, env=env_scene3, tensorboard_log=tensorboard_log_path_scene3, policy_kwargs=policy_kwargs, verbose=2, learning_rate=5e-5)
